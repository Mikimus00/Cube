public class R3Vector {
    ...
    public double sin(double U){
        ...
        return Math.sin(U);}//синус от угла U
    ...
    public void VRound(double ux, double uy, double uz){
        ...
        if (ux>0){VRound(Ox,ux);}
        else     {VRound(Ox,360+ux);}

        if (uy>0){VRound(Oy,uy);}
        else     {VRound(Oy,360+uy);}

        if (uz>0){VRound(Oz,uz);}
        else     {VRound(Oz,360+uz);}
    }
    ...
    public void VRound(R3Vector O, double U){
        ...
        if      (O.x==1){x=C1;y=C3;z=C2;}
        else if (O.y==1){x=C1;y=C2;z=C3;}
        else            {x=C2;y=C1;z=C3;}
